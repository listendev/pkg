...
func TestAnalysisRequestFromJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "valid full pypi static (code execution) analysis request",
			args: args{
				body: []byte(`{"type": "urn:hoarding:static,code_exec_at_setup!pypi.json", "snowflake_id": "1652803364692340737", "name": "cctx", "version": "1.0.0", "sha256": "1d9ceb0603ed51a4f337cb8d53dd320339fd10814642d074b41a86d00be0bdbd", "blake2b_256": "bdd235ad05b2669c50fc2756e35d0fe462bbd085a5b7afb571f443fd2ceb151e", "priority": 5, "force": true}`),
			},
			want: &PyPi{
				base: base{
					RequestType: PypiStaticAnalysisCodeExecutionAtSetup,
					Snowflake:   "1652803364692340737",
					Priority:    5,
					Force:       true,
				},
			...
			wantPublishing: &amqp.Publishing{
				ContentType: "application/json",
				Priority:    5,
				Body:        []byte(`{"type":"urn:hoarding:static,code_exec_at_setup!pypi.json","snowflake_id":"1652803364692340737","name":"cctx","version":"1.0.0","priority":5,"force":true,"sha256":"1d9ceb0603ed51a4f337cb8d53dd320339fd10814642d074b41a86d00be0bdbd","blake2b_256":"bdd235ad05b2669c50fc2756e35d0fe462bbd085a5b7afb571f443fd2ceb151e"}`),
			},
			wantKey: "pypi/cctx/1.0.0/bdd235ad05b2669c50fc2756e35d0fe462bbd085a5b7afb571f443fd2ceb151e/static(code_exec_at_setup).json",
			wantErr: false,
		},
		{
